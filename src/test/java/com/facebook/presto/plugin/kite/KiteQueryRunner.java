...
public final class KiteQueryRunner
{
    private static final String CATALOG = "kite";

    private KiteQueryRunner() {}
            ...
            throws Exception
    {
        ...
        try {
            queryRunner.installPlugin(new KitePlugin());
            queryRunner.createCatalog(CATALOG, "kite", ImmutableMap.of());
            ...
            throws Exception
    {
        ...
        Thread.sleep(10);
        Logger log = Logger.get(KiteQueryRunner.class);
